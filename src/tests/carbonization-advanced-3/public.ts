...
export const CARBONIZATION_ADVANCED_3_PUBLIC: PublicTest = {
  ...
  questions: [
    ...
    },
    {
      ...
      content: "Охладить смесь, чтобы повысить растворимость CO₂ при том же давлении. Увеличить контакт фаз через агитацию, чтобы быстрее прийти к равновесию. Подавать CO₂ внутрь жидкости, чтобы расширить площадь контакта. Поднять температуру, чтобы повысить растворимость CO₂ при том же давлении. Учесть сахар как фактор вязкости и конкуренции за воду при насыщении. Проверять камень на трещины и обслуживать, чтобы поддерживать работу.",
      markedParts: [
        { id: 1, text: "Охладить смесь, чтобы повысить растворимость CO₂ при том же давлении.", start: 0, end: 69 },
        { id: 2, text: "Увеличить контакт фаз через агитацию, чтобы быстрее прийти к равновесию.", start: 71, end: 143 },
        { id: 3, text: "Подавать CO₂ внутрь жидкости, чтобы расширить площадь контакта.", start: 145, end: 208 },
        { id: 4, text: "Поднять температуру, чтобы повысить растворимость CO₂ при том же давлении.", start: 210, end: 284 },
        { id: 5, text: "Учесть сахар как фактор вязкости и конкуренции за воду при насыщении.", start: 286, end: 355 },
        { id: 6, text: "Проверять камень на трещины и обслуживать, чтобы поддерживать работу.", start: 357, end: 426 },
      ],
      allowMultiple: true,
