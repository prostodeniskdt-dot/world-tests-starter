    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        ...
        <p className="text-zinc-600 leading-relaxed">
          Сиропы, пюре, тоники, соки и прочие безалкогольные ингредиенты
        </p>
      </div>
      ...
      {loading ? (
        ...
        <CatalogEmpty
          ...
          description="Раздел наполняется. Скоро здесь появится каталог безалкогольных ингредиентов."
        />
      ) : (
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
          {items.map((item) => (
