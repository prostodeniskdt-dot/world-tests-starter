    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      {loading ? (
        ...
        <CatalogEmpty
          ...
          description="Раздел наполняется. Скоро здесь появится каталог коктейлей с рецептами."
        />
      ) : (
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
          {items.map((item) => (
            ...
            >
              ...
              <div className="p-3">
                ...
                {item.is_classic && (
                  <span className="text-xs text-primary-600">Классика</span>
                )}
              </div>
            </Link>
          ))}
