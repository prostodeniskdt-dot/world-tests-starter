    ...
    <div className="min-h-screen bg-zinc-50">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <h1 className="text-2xl font-bold text-zinc-900">Каталог техники</h1>
        </div>
        <p className="text-zinc-600">
          Добавление и редактирование — раздел в разработке. Таблицы: equipment, equipment_categories.
        </p>
      </div>
    </div>
  );
